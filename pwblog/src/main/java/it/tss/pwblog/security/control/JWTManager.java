 ...
 */
package it.tss.pwblog.security.control;
...
public class JWTManager {
    ...
    public String generate(BlogUser usr) {
    ...
    private JSONObject generateJWT(BlogUser usr) {
    ...
    private JSONArray loadGroups(BlogUser user) {
